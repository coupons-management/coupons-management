                        ...
                        <div class="card-body js-store-list">
                            <ul class="list-group list-group-flush">
                                <c:forEach items="${stores}" var="store">
                                    <li class="list-group-item">
                                        <a href="${basePath}/green/store/${fn:replace(fn:replace(fn:replace(store.webSite,'www.',''),'http://',''),'https://','')}">${store.storeName}</a>
                                    </li>
                                </c:forEach>
                            ...
                            <div class="col-sm-6 col-md-4 col-12 py-1 py-sm-2 px-2">
                                ...
                                <div class="coupon-item row no-gutters">
                                    ...
                                    <div class="info-box col-9 col-sm-12 d-flex flex-wrap align-content-between">
                                        <a target="_blank" rel="nofollow" href="${basePath}/green/store/${fn:replace(fn:replace(fn:replace(coupon.storeWebSite,'www.',''),'http://',''),'https://','')}?c=${coupon.id}"
                                           class="coupon-title text-left text-sm-center" url="${coupon.link}">
                                            <h3>${coupon.title}</h3>
                                        </a>

                                        <div class="extra-info">
                                        <span class="use-info"><i class="fa fa-user mr-1"
                                                                  aria-hidden="true">12</i> USED</span>
