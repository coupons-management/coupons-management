  ...
  @Override
	public boolean equals(Object that) {
		...
		return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
				...
				&& (this.getStoreCount() == null ? other.getStoreCount() == null
						: this.getStoreCount().equals(other.getStoreCount()))
				&& (this.getCouponCount() == null ? other.getCouponCount() == null
						: this.getCouponCount().equals(other.getCouponCount()))
				&& (this.getAdAddress() == null ? other.getAdAddress() == null
						: this.getAdAddress().equals(other.getAdAddress()))
				&& (this.getMark() == null ? other.getMark() == null : this.getMark().equals(other.getMark()))
				&& (this.getIsManual() == null ? other.getIsManual() == null
						: this.getIsManual().equals(other.getIsManual()))
				...
				&& (this.getStoreDes() == null ? other.getStoreDes() == null
						: this.getStoreDes().equals(other.getStoreDes()))
				&& (this.getHeaderDes() == null ? other.getHeaderDes() == null
						: this.getHeaderDes().equals(other.getHeaderDes()))
				&& (this.getHotSort() == null ? other.getHotSort() == null
						: this.getHotSort().equals(other.getHotSort()))
				&& (this.getAdviseSort() == null ? other.getAdviseSort() == null
						: this.getAdviseSort().equals(other.getAdviseSort()));
	}
