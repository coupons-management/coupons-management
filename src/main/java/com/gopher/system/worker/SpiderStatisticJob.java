...
public class SpiderStatisticJob {
            ...
            for (CpScrapy cpScrapy : list) {
                ...
                if (null != storeList) {
                    for (CpStore store : storeList) {
                        ...
                        final int incrementCount = this.getIncrementCount(storeId, yesterday, beforeYesterday);
                        final int totalCount = this.getTotalCount(storeId);
                        final int validCount = this.getValidCount(storeId, yesterday);
     ...
     * @return
     */
    private int getIncrementCount(int storeId, Date yesterday, Date beforeYesterday) {
     ...
     * @return
     */
    private int getValidCount(int storeId, Date yesterday) {
        SpiderStatisticVO query = new SpiderStatisticVO();
        query.setStoreId(storeId);
